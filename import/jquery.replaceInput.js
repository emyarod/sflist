...
var viewInput = {
  ...
  "downforward"   : "<img class='rotate3' src='/sflist/img/arrow_a.png' />",
  "down"          : "<img class='rotate2' src='/sflist/img/arrow_a.png' />",
  "downback"      : "<img class='rotate1' src='/sflist/img/arrow_a.png' />",
  "back"          : "<img class='rotate4' src='/sflist/img/arrow_a.png' />",
  "upback"        : "<img class='rotate7' src='/sflist/img/arrow_a.png' />",

  "chdown"        : "<img class='rotate2' src='/sflist/img/arrow_b.png' />",
  "chdownback"    : "<img class='rotate1' src='/sflist/img/arrow_b.png' />",
  "chback"        : "<img class='rotate4' src='/sflist/img/arrow_b.png' />",

  "dpf"           : "<span style='white-space:nowrap;'><img class='rotate6' src='/sflist/img/arrow_a.png' /><img class='flow rotate2' src='/sflist/img/arrow_a.png' /><img class='flow rotate3' src='/sflist/img/arrow_a.png' /></span>",
  "dpb"           : "<span style='white-space:nowrap;'><img class='rotate4' src='/sflist/img/arrow_a.png' /><img class='flow rotate2' src='/sflist/img/arrow_a.png' /><img class='flow rotate1' src='/sflist/img/arrow_a.png' /></span>",

  "qcf"           : "<img class='rotate1' src='/sflist/img/qcf.png' />",
  "qcb"           : "<img class='rotate3' src='/sflist/img/qcb.png' />",

  "hcf"           : "<img class='rotate1' src='/sflist/img/hcf.png' />",
  "hcb"           : "<img class='rotate3' src='/sflist/img/hcb.png' />",

  "360"           : "<img class='rotate4' src='/sflist/img/360.png' />",

  "cwing"         : "<img class='rotate2' src='/sflist/img/hcf.png' />",
